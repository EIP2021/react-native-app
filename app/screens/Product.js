...
class Product extends Component {
  ...
  componentDidMount = async () => {
    ...
    const nutriments = {
      sodium_value: nm.sodium_value,
      sodium_unit: nm.sodium_unit,
      potassium_value: nm.potassium_value,
      potassium_unit: nm.potassium_unit,
      proteins_value: nm.proteins_value,
      proteins_unit: nm.proteins_unit,
      calcium_value: nm.calcium_value,
      calcium_unit: nm.calcium_unit,
    };
    let chartData = [{
  ...
  render() {
    ...
    const list = [{
      ...
      title: 'Sodium', icon: 'info-with-circle', color: '#2ecc71', rightTitle: `${toDec(this.state.data.nutriments.sodium_value)} ${this.state.data.nutriments.soium_unit || 'mg'}`,
    }, {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.list}>
          ...
          <Button title="Ajouter" buttonStyle={styles.button} />
        </View>
      </View>
    );
  }
